      ...
      <main className="min-h-screen bg-[#E8D8C6] flex items-center justify-center px-4 py-12 font-body relative overflow-hidden">
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 rounded-2xl overflow-hidden shadow-2xl shadow-[#C77A23]/20 border border-[#C77A23]/20 relative z-10">
          ...
          <section className="lg:col-span-7 p-8 lg:p-12 bg-white flex flex-col justify-center">
            <div className="mb-8">
              <span className="inline-block bg-[#C77A23]/10 text-[#C77A23] text-xs font-body font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-3">Join Us</span>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" autoComplete="off">
              <div>
                <label className="block text-xs font-body font-bold uppercase tracking-wider text-[#3A2F2B] mb-2">Nama Lengkap</label>
              ...
              <div>
                <label className="block text-xs font-body font-bold uppercase tracking-wider text-[#3A2F2B] mb-2">No. HP (Opsional)</label>
                <div className="relative flex items-center">
                  <svg className="absolute left-4 w-4 h-4 text-[#3A2F2B]/20 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              <button
                type="submit"
                disabled={loadingRegister}
                className={`w-full py-4 rounded-xl font-body font-bold text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-2 ${
                  loadingRegister ? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-[#C77A23] text-white hover:bg-[#3A2F2B] shadow-lg shadow-[#C77A23]/20 hover:shadow-xl hover:shadow-[#3A2F2B]/20"
                }`}
              >
                {loadingRegister ? (
                  <>
